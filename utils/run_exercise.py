...
class ExerciseRunner:
    ...
    def create_network(self):
        ...
        # edit by xipeng to avoid logging 2021-05-23
        '''
        ...
        # edit by xipeng 20210525 to get links
        #flink = open("../links.json","w")
        #json.dump(self.topo.links(sort=True,withKeys=True,withInfo=True), flink)
        #flink.close()
    ...
    def program_switch_p4runtime(self, sw_name, sw_dict):
        ...
        with open(runtime_json, 'r') as sw_conf_file:
            ...
            # edit by xipeng 2021-05-23 to avoid logging
            outfile = None
